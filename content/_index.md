...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        Интересуюсь **компьютерной алгеброй** и символьными вычислениями. Изучаю систему **SageMath** для решения задач теории чисел, алгебраической геометрии и работы с полиномами.

        Программирую на **C++** и **Python** — нравится как эффективная реализация алгоритмов, так и быстрое прототипирование. Считаю, что хороший код должен быть не только правильным, но и красивым.

        В свободное время учу иностранные языки и бегаю. Бег помогает структурировать мысли и находить нестандартные решения сложных задач 😊
    design:
      columns: '1'
  - block: collection
    id: papers
